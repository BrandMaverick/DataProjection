                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-4 offset-sm-1">
                        ...
                        <address>
                            16780 NE 86th CT<br />
                            Redmond WA - 98052<br />
                            <i className="fa fa-phone fa-lg"></i>: 425-283-3253<br />
                            <i className="fa fa-fax fa-lg"></i>: 425-283-3253<br />
                            <i className="fa fa-envelope fa-lg"></i>: <a href="mailto:garg.sanjay@gmail.com">garg.sanjay@gmail.com</a>
                        </address>
                    </div>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".firstname" id="firstname" name="firstname" placeholder="First Name" className="form-control"
                                        validators={{ required, min: minLength(3), maxLength: maxLength(15) }} />
                                    <Errors 
